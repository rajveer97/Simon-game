...
$(".btn").click(function() {
  ...
  // Inside the handler, create a new variable called userChosenColour to store
...
function nextSequence() {
  ...
  //2. Use Google/Stackoverflow to figure out how you can use jQuery to animate
  //a flash to the button selected in step 1.
...
function animatePress(currentColor) {
  ...
  //use Google/Stackoverflow to figure out how you can use Javascript to
